...
#N4XWE 2-18-2021
#Test Compiled on Ubuntu Mate 20.10 for the Raspberry Pi 64-bit
...
python3-mako python3-sphinx python3-lxml python-doc8-doc doxygen libfftw3-dev \
...
python3-cairocffi python3-gobject python3-nose python3-tornado texlive-extra-utils \
texlive-latex-extra ttf-staypuft python3-gdal python3-pydot python3-pygraphviz \
libgle3 tix python3-tk-dbg ||
...
git clone https://github.com/noc0lour/gr-grnet/

#Change the directory containing the gr-grnet source code to the current directory
cd ~/src/GNURadio/gr-grnet

#Checkout the 3.8 branch of gr-grnet for GNU Radio from the cloned noc0lour github repository
git checkout 3.8
git submodule update --init --recursive
