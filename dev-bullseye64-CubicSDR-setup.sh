#!/bin/sh
#install CubicSDR (0.2.8) wxWidgets (3.2.1) Hamlib (4.6git)
#N4XWE 06-12-2023
...
#Download the version 3.2.1 of the WxWidgetss source code from github
...
cmake ../ -DCMAKE_BUILD_TYPE=Release -DwxWidgets_CONFIG_EXECUTABLE=~/Develop/wxWidgets-staticlib/bin/wx-config -DINSTALL_UDEV_RULES=ON -DUSE_HAMLIB=1 -DUSE_AUDIO_PULSE=1 -DUSE_AUDIO_OSS=0 -DUSE_AUDIO_ALSA=1 -DOTHER_LIBRARIES="-latomic"
