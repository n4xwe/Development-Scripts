...
tcl-dev python3-gi-cairo python3-cairo-dev python-cairo libspeex-dev libasound2-dev alsa-utils libgcrypt20-dev libgsm1-dev python-dev-is-python3 python-dateutil \
...
libgirepository1.0-dev libcppunit-dev python3-watchdog ||
...
mkdir -p ~/src/HAYSTACK/digital_rf/build && cd ~/src/HAYSTACK/digital_rf/build
